...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('kind', models.CharField(choices=[('Купля-продажа', [('b', 'Куплю'), ('s', 'Продам')]), ('Обмен', [('c', 'Обменяю')])], default='s', max_length=1)),
                ...
                ('published', models.DateTimeField(auto_now_add=True, db_index=True, verbose_name='Опобликовано')),
